<?php include('components/header.php'); ?>
            <!-- Home Section -->
            <section class="page-section bg-dark-alfa-50 bg-scroll" data-background="images/about-bg.jpg" id="home">
                            ...
                            <div class="row alt-features-grid">
                                ...
                                <div class="col-lg-6">
                                    <div class="alt-features-item">
                                        ...
                                        <h3 class="alt-features-title">Steady Groth</h3>
                                        <div class="alt-features-descr">
                                            Since its inception, SBIPL has been able to ensure the highest level of
                                            quality standards & excellence in delivery which has helped us grow rapidly
                                ...
                                <div class="col-lg-6">
                                    <div class="alt-features-item">
                                        ...
                                        <h3 class="alt-features-title">Expert Teams</h3>
                                        <div class="alt-features-descr">
                                            Well-trained staffing and attention to detail with a hunger for delivering
                                            quality products at every cost have made SBIPL a choice for its customers.
                                        </div>
                                    </div>
                                </div>
                                <!-- End Features Item -->
                                ...
                                <div class="col-lg-6">
                                    <div class="alt-features-item">
                                        ...
                                        <h3 class="alt-features-title">Design Expertise</h3>
                                        <div class="alt-features-descr">
                                            the complete suite of the solution under one roof, from designing to
                                            printing corrugation and cutting/pasting has enabled SBIPL to optimize the
                                            costs without compromising quality for its customers.
                                ...
                                <div class="col-lg-6">
                                    <div class="alt-features-item">
                                        ...
                                        <h3 class="alt-features-title">The latest Equipment & Machinery</h3>
                                        <div class="alt-features-descr">
                                            investment in high-end printers and equipment has ensured an edge for SBIPL
                                            over its competitors. Besides our commitment to high standards in quality,
                                            we have been able to provide great finish and looks in our products.
                        ...
                        <div class="col-lg-6">
                            <div class="call-action-3-images mt-xs-0 text-end">
                                ...
                                <div class="call-action-3-image-1 wow fadeInRight">
                                    <img src="images/about-us-2.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s"
                                        data-wow-offset="205" />
                                </div>

                                <div class="call-action-3-image-2-wrap d-flex align-items-center">
                                    <div class="call-action-3-image-2 wow fadeInRight">
                                        <img src="images/about-us-1.jpg" alt="" class="wow scaleOutIn"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 text-center">
                            <!-- The Timeline -->
                            <h2 class="section-title mb-60 mb-sm-30">Timeline</h2>
                            <ul class="timeline">
                                ...
                                <li>
                                    <div class="direction-r">
                                        <div class="flag-wrapper">
                                            <span class="flag">2001</span>
                                        </div>
                                        <div class="desc">Started with a setup of 900 SQFT in Delhi</div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="direction-l">
                                        ...
                                        <div class="desc">Shifted to a 5000 SQFT area to add more plant & machine</div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="direction-r">
                                        ...
                                        <div class="desc">Got register in under a excisable</div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="direction-l">
                                        ...
                                        <div class="desc"> Became a private limited company, Got our first 4 colour
                                            offset printing machine </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="direction-r">
                                        ...
                                        <div class="desc">Go the 5-colour offset printing machine</div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="direction-l">
                                        ...
                                        <div class="desc">Moved to an 50,000 SQFT manufacturing unit in the Industrial hub of Sonipat, Haryana</div>
                                    </div>
                                </li>
                ...
                <div class="container relative">
                    ...
                    <div class="row reverse">
                        ...
                        <div class="col-lg-8">
                            <div class="mt-140 mt-lg-80 mt-md-60 mt-xs-30 mb-140 mb-lg-80">
                                <div class="banner-content wow fadeInUpShort" data-wow-duration="1.2s">
                                    <h3 class="banner-heading">Manmohan Gupta</h3>
                                    <div class="banner-decription">
                                        Manmohan Gupta is the founder of SBIPL and has been heading the sales and
                                        marketing division of the organization.
                                        It is his vision & wisdom which lead SBIPL from a bootstrap startup to now a 100
                                        people + strong team. With a thorough understanding of traditional and emerging
                                        marketing channels & his ability to think creatively and innovatively, he was
                                        able to forecast and identify trends and challenges for SBIPL and guide the team
                                        towards excellence and establish SBIPL as a strong player in its vertical.
                                    </div>
                        ...
                        <div class="col-lg-4 relative">
                            <div class="">
                                <img src="images/vikas-gupta.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s"
                                    data-wow-offset="292" />
                            </div>
                        </div>
            ...
            <section class="page-section pt-0 pb-0 banner-section bg-dark light-content">
                <div class="container relative">
                    ...
                    <div class="row reverse1">
                        ...
                        <div class="col-lg-4 relative">
                            <div class="">
                                <img src="images/manmohan-gupta.jpg" alt="" class="wow scaleOutIn"
                        ...
                        <div class="col-lg-8">
                            <div class="mt-140 mt-lg-80 mt-md-60 mt-xs-30 mb-140 mb-lg-80">
                                <div class="banner-content wow fadeInUpShort" data-wow-duration="1.2s">
                                    <h3 class="banner-heading">Vikas Gupta</h3>
                                    <div class="banner-decription">
                                        As a production and design head, he is at the core of every design and product
                                        innovation at SBIPL. His brilliance, flair and vision are the reason for
                                        superior quality products which gives us an edge in the market. <br>
                                        He is directly involved in the production process and can be seen delegating and
                                        pushing people for the highest levels of quality and adherence to timeliness. He
                                        is considered the lifeline of SBIPL.
                ...
                <div class="container relative">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 mb-md-60 wow fadeScaleIn" data-wow-duration="1.5s">
                            <img src="images/satyanarayan-gupta.jpg" alt="Add Your Description" />
                        </div>

                        <div class="col-lg-6 offset-lg-1 d-flex align-items-center wow fadeInUpShort">
                            <div>
                                <h2 class="section-title">Satyanarayan Gupta</h2>
                                <p>He has been a guiding force for everyone in the company for more than two decades
                                    now. He serves as an advisor for the organization and with his business acumen and
                                    vision for the future, he has successfully brought the organization to where it is
                                    today.</p>
                                <p>He has played a major role in establishing SBIPL as a process driven independent
                                    organization than a family business.</p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="work-process-item text-center pt-20">
                                ...
                                <h3 class="work-process-title">More than 20 years of experience and expertise in this
                                    industry</h3>
                            </div>
                        </div>
                        <!-- End Item -->
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="work-process-item text-center pt-20">
                                ...
                                <h3 class="work-process-title">Ability to churn out 1 lakh boxes per day</h3>
                            </div>
                        </div>
                        <!-- End Item -->
                    ...
                    <div class="row">
                        <div class=" col-lg-8 offset-lg-2 wow fadeInUpShort">
                            ...
                            <div class="text-center mb-50 mb-sm-20">
                                <h2 class="section-title txt-wht">What People Say?</h2>
                            </div>
                            ...
                            <div class="text-slider">
                                ...
                                <div>
                                    <blockquote class="testimonial">
                                        <p>
                                            We always trust SBIPL with any packaging work to be done. Their boxes are
                                            what we need
                                        </p>
                                ...
                                <div>
                                    <blockquote class="testimonial">
                                        <p>
                                            Their products are well-crafted and of excellent quality. Just right for our
                                            company’s needs
                                        </p>
                                        <footer class="testimonial-author mt-50 mt-sm-20">
                                            — Mark Extralife
                                ...
                                <div>
                                    <blockquote class="testimonial">
                                        <p>
                                            We are extremely grateful to have a long-standing association with Shivam
                                            Brandwrappers. By using their products for ourselves, we would like to
                                ...
                                <div>
                                    <blockquote class="testimonial">
                                        <p>
                                            Our clients and customers are impressed with the designs made on our
                                            products. This is only possible with the innovation shown by Shivam
                                            Brandwrappers.
                                        </p>
                                        <footer class="testimonial-author mt-50 mt-sm-20">
                                            — Swiss
